        ...
        <div>
            ...
            <Link to={`/blog/${posts[0].slug}`}>
                <div className="relative grid lg:grid-cols-12 sm:grid-cols-12 items-center justify-start sm:justify-between gap-4 bg-slate-200 p-8 rounded-2xl">
                    ...
                    <img src={posts[0].image} alt={posts[0].imageAlt} className="w-full object-cover lg:col-span-3 sm:col-span-1 h-96 rounded-lg aspect-[3/4] lg:order-2 sm:order-1" />
                </div>
            </Link>
                ...
                {posts.slice(1).map((post, index) => (
                    <div key={index} className="mb-8">
                        <Link to={`/blog/${post.slug}`}>
                            <div>
                                <img src={post.image} alt={post.imageAlt} className="rounded-lg w-full object-cover h-[500px]" />
                            </div>
                            <div className="mt-8">
