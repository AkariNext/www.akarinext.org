  ...
  return (
    <div>
      ...
      <div className="mt-16 rounded-lg min-h-96">
        <div className="text-slate-700 text-2xl font-bold text-center">運営メンバー</div>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
          ...
          <div className="w-full h-full bg-slate-200 rounded-lg p-8">
            <div className="text-slate-700 text-2xl font-bold text-center">PLAYING GAME'S</div>

          </div>
          <div className="w-full h-full bg-slate-200 rounded-lg p-8">
            <div className="text-slate-700 text-2xl font-bold text-center">WORKS</div>
          </div>
        </div>
      </div>
    </div>
